...
<html lang="en">
  <head>
    ...
    <title>ZOOM4WEB - ZOOM 4 WEB 3 Responsive Admin Template</title>
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu">                
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a class="" href="submap.php">Subject Mapping</a></li>
                          <li><a class="" href="attendence.php">Attendence</a></li>
                  ...
                  <li class="sub-menu">                     
                      ...
                      <ul class="sub">
                          <li><a class="" href="chart-chartjs.html">Li</a></li>
                           <li><a class="" href="chart-chartjs.html">New Registration</a></li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a class="" href="basictable.php">Basic Table</a></li>
                      </ul>
                  </li>
