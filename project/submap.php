...
<form name=""class="form-validate form-horizontal"  method="post" action="insert2.php">
<?php
...
?>
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                             <select class="form-control " id="cemail" type="text" name="facultyname">
                                             ...
                                             <option value="<?php echo $fetch['facultyname']?>"><?php echo $fetch['facultyname']?></option>
                                             <?php }?>
                                             </select>
                                          </div>
                                      </div>
