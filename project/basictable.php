...
<html lang="en">
  <head>
    ...
    <title>Basic Table |ZOOM 4 WEB  -  3 Responsive Admin Template</title>
...
<td>
<form action="faculty/delete.php" name="" method="post">
<input type="hidden" name="id" value="<?php echo $fetch['id']?>">
...
<td>
<form action="students/delete.php" name="" method="post">
<input type="hidden" name="id" value="<?php echo $fetch['id']?>">
<input type="submit" name="submit" value="delete">
</form>
</td>
...
$select="select leavetable.*,facultyform.* from  leavetable LEFT JOIN facultyform on leavetable.empid=facultyform.id ";
...
<a href="formvalidation.php?leaveid=<?php echo $fetch['id1']; ?>" >view</a>
...
$con=mysql_connect("localhost","root","");
$db=mysql_select_db("students",$con);
$select="select suggesiontable.*,registrationform.* from  suggesiontable LEFT JOIN registrationform on suggesiontable.sug_id=registrationform.studentid ";
$query=mysql_query($select);
...
<tr>
<td><?php echo $a;?></td>
<td><?php echo $fetch['sug_id'];?> </td>
<td><?php echo $fetch['studentname'];?> </td>
<td><?php echo $fetch['message_date'];?> </td>

<td>

<a href="formsuggision.php?suggesionid=<?php echo $fetch['sid']; ?>" >view</a>
...
<tr>
<td><?php echo $a;?></td>
<td><a href="#"><?php echo $fetch['title'];?> </a></td>
<td><?php echo $fetch['attachment'];?> </td>
<td>

<a href="circularform.php?circularid=<?php echo $fetch['cid']; ?>" >view</a>
...
<a href="upload.php?uploadid=<?php echo $fetch['uid']; ?>" >view</a>
...
<tr>
<td><?php echo $a;?></td>
<td><?php echo $fetch['subid'];?> </td>
<td><?php echo $fetch['subjects'];?> </td>
<td>

<a href="subjectsform.php?subid=<?php echo $fetch['s_id']; ?>" >view</a>
