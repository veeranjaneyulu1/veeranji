...
<img src="IMG_7250 copy.png" style="float:right;" />
<img src="SR-Set-3-Fan-Display-Small-size.png" style="float:right;" />
<img src="2.png" style="float:left;" />
<img src="PTI11_29_2013_000158A_Kand.png" style="float:right;" />


<h1 style="text-align:center;margin:0px;padding:28px;color:#E2FF00;padding-left:442px;">Student Details Form</h1>
</div>

<body style="background:url(green-border-backgrounds-powerpoint.jpg);background-size:cover;margin:0px auto;width:100%;">
 
<div style="margin:0px auto;">
<div style="width:390px;margin:0px auto;padding:80px;background:url(flowers_texture703.jpg);">
