...
<img src="images/logo.png" style="float:left;padding:28px;padding-left: 4px"/>


<h1 style="text-align:center;margin:0px;padding:28px;color:#088bd7;padding-right:295px;">Faculty Registration Edit Form</h1>
</div>

<body style="background:url(images/art-vector-flowers-background-wallpaper-image-207562.jpg) no-repeat;margin:0px auto;width:100%;">
...
<tr>
<td >Address:</td>
<td><textarea name="Address" rows="5" cols="21" style="width:172px; margin-bottom:5px; padding-bottom:10px; border-radius:5px;" >
