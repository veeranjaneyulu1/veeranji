                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended logout">
                            ...
                            <li>
                                <a href="mainpage.php"><i class="icon_key_alt"></i>Log Out</a>
                            </li>
                            <li>
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu">                
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">                          
                          <li><a class="" href="student-corner/admit/student/studentinfo.php">Profile</a></li>
...
<tr>
<td><?php echo $a++;?></td>
<td><?php echo $fetchh['NameoftheFaculty'];?> </td>
<td>
<form action="profile.php" name="" method="post">
<input type="hidden" name="id" value="<?php echo $fetchh['id']?>">
<input type="submit" name="submit" value="view">
</form>
</td>
<td>
<form action="faculty/facultyeditform.php" name="" method="post">
<input type="hidden" name="id" value="<?php echo $fetchh['id']?>">
...
$sql="select * from student_master_attendance"; 
...
<td>
<form action="profile.php" name="" method="post">
<input type="hidden" name="id1" value="<?php echo $fetch['stud_id']?>">
...
<td>
<form action="student/delete.php" name="" method="post">
<input type="hidden" name="id1" value="<?php echo $fetch['stud_id']?>">
<input type="submit" name="submit" value="delete">
</form>
</td>
